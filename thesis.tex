...
%        appear at $\pm 4 e^2/h$. 
    ...
    \section{Doping graphene}
        ...
        \subsection{Electrostatic gating}
            ...
            \includegraphics[width=0.4\textwidth]{images/background/gate_sweep_doping.png}
            ...
            Right: Conductance vs gate voltage measurements for a graphene device exposed to a 
        ...
        position of the Fermi level, i.e. the position of Fermi level in the absence of external doping. 
        ...
        Finally, it is also possible to produce separate, distinctly doped regions in
        ...
        Polar dopant molecules add an additional degree of freedom to a graphene device. In particular
        if the dopant molecule contributes a varying amount of charge depending on its polarization
        then measurement processes which alter the polarization of the dopant molecule can induce
        additional dynamics in the measurements.
