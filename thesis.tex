...
%        appear at $\pm 4 e^2/h$. 
    ...
    \section{Doping graphene}
        ...
        \ref{fig:GonPZT}. The electric field from the polarized substrate creates a local potential
        which dopes the graphene in a manner analogous to the doping created by the electric field of a backgate.
    ...
    \section{Straining graphene}
        ...
        In this section I summarize previous work concerning these
        strain-dependent effects.
        
        \subsection{Observing strain via Raman spectroscopy}
        
        Raman spectroscopy is often us
        ...
        strain on graphene.
        Uniaxial strain is predicted to open a gap in the band structure, either by 
        itself at high (\textgreater 20\%) strains \cite{Pereira2009} or in conjunction with a correlated scalar 
        potential \cite{Low2011}. Experimental work following the latter approach 
        ...
        Theoretical \cite{Guinea2009} and experimental \cite{Levy2010}, \cite{Yan2012} 
