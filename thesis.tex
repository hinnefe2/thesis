...
\chapter{Experimental Techniques}
    ...
    \section{Sample Fabrication}
        ...
        \subsection{Substrate patterning}
            ...
            an O$_2$ plasma and for SiO$_2$ etching we use CHF$_3$ CHECK THIS.
    ...
    The primary challenge of experimental condensed matter research, at least as measured by graduate student effort, lies in fabricating working devices. The fabrication techniques described above require finesse, skill, and a certain degree of luck (especially when working with temperamental equipment). As such, a substantial fraction of the fabricated devices will fail to work. Characterizing the different failure modes of a given fabrication process -- and thereby determining the optimal process parameters -- is a crucial part of each research project. In this section several techniques which effectively characterize the quality and physical integrity of graphene and other fabricated device elements are described.
        ...
        across a region of interest on can map local variations in peak locations.
        
        \note{PUT MORE DETAIL HERE, INTRO TO STRAIN ARRAY PAPER}
    ...
    In this section I describe the methods used to create the required environments, the equipment use to
    perform the measurements, and the various configurations used to connect devices to measurement instrumentation.
        ...
        and thus the lateral displacement of the second clamp. At maximum extension this device is capable of applying up to three
        percent strain to substrates. 
        
        \note{something about the arduino to control it}
        ...
        When combined, these techniques are capable of producing vacuums in the XXX mtorr range.
        \note{maybe talk about two stage process, being careful not to damage the turbo pump}
        
        \note{LOOK UP VACUUM VALUE}
        ...
        \subsection{Measurement equipment}
            ...
            In this section we describe the relevant characteristics of the primary pieces of measurement
            instrumentation used in this research.
            
            \subsubsection*{Keithley 2400 SMU} The Keithley 2400 is a source-measure unit (SMU) capable of 
            ...
            The wide operational range comes at the expense of precision; Figure \ref{fig:electronics_noise}A
            shows the measured output of a Keithley 2400 set to source 100 mV
            
            \subsubsection*{National Instruments BNC2110 DAC} The National Instruments BNC2110 digital-to-analog converter (DAC)
            is another source-measure unit.
            Makes the opposite tradeoffs : it provides high precision sourcing and measurement in a 
            limited operational range.
            
            \subsubsection*{Stanford Research System SR830} The SR830 is a lock-in amplifier.
            
            \subsubsection*{Current preamplifiers}
            
            \subsubsection*{Voltage preamplifiers}
        ...
        readily observed via electrical transport measurements. 
...
\section{Graphene on flexible substrates}
    ...
    \subsection{Device configuration}
        ...
        \centering
        \vspace{0.2cm}
        \includegraphics[width=\linewidth]{images/resultsanddiscussion/rippingpaper/Figure1.eps}
...
%\textbf{Device Fabrication.} Substrates were prepared by pulsed-laser deposition: strontium titanate (SrTiO$_3$) substrates were first coated with 20 nm of strontium ruthenate (SrRuO$_3$) followed by 120 nm of (001)-oriented lead zirconium titanate (PbZr$_{0.2}$Ti$_{0.8}$O$_3$). The details of the substrate fabrication are discussed in refs. [21,22].
%\citet{Xu2014,Karthik2012}.
%For each substrate, 80 nm of SiO$_2$ was evaporated in small rectangular regions defined by conventional photolithography. CVD graphene was then transferred onto the substrate using standard wet-transfer techniques as discussed in ref. [23].
%\citet{Li2009}.
%Photolithography was used to define graphene channels which spanned the evaporated SiO$_2$ regions; the remainder of the graphene was removed by oxygen plasma etching. Finally, electrical leads were defined in a four-point measurement configuration using photolithography, and 20 nm of gold was deposited by electron-beam evaporation with a 3 nm sticking layer of titanium.
